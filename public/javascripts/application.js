$(document).ready(function(){
  ...
  /// Sign in buttons ///
  $("ul#sign_in_via img").mouseover(function(){
    var offset_top  = $(this).offset().top;
    var offset_left = $(this).offset().left;

    $("body").prepend("<div id='dummy' style='font-style: italic; color: #666; opacity: 0; position: fixed; top: " + (offset_top + 7) + "px; left: " + (offset_left + 40) + "px;'>" + $(this).attr("rel") + "</div>");
